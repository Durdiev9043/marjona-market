...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Marjona online market</title>
      ...
      <div class="banner_bg_main">
         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="logo"><a href="index.html"><img width="80%" src="{{ asset('LogoMarjonaSupermarket.png') }}"></a></div>
{{--                      images/logo.png--}}
                  </div>
               </div>
            </div>
      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">Ichimliklar</h1>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">Narxi  <span style="color: #262626;">{{ $item->price }}</span></p>
                                 <div class="tshirt_img"><img src="http://marjona-market.uz/storage/galereya/{{ $item->img }}"></div>
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Sotib olish</a></div>
                                    <div class="seemore_bt"><a href="#">Batafsil</a></div>
                                 </div>
                              </div>
                           </div>
                            @endforeach
      ...
      <div class="fashion_section">
         <div id="electronic_main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">Shirinliklar</h1>
                     <div class="fashion_section_2">
                        <div class="row">
                            @foreach($shsh as $item)
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        <h4 class="shirt_text">{{ $item->name }}</h4>
                                        <p class="price_text">Narxi  <span style="color: #262626;">{{ $item->price }}</span></p>
...
{{--            </a>--}}
      ...
      <section class="pt-5 pb-5">
          <div class="container">
              <div class="row">
                  <div class="col-6">
                      <h1 class="fashion_taital">Oziq-ovqat mahsulotlari</h1>
{{--                      <h3 class="mb-3">Oziq-ovqat mahsulotlari</h3>--}}
                  </div>
